// The initial version of this was was directly a copy from the sage.
// Which I sincerely feel is such an elegant implementation.
// https://github.com/lazear/sage/crates/sage/src/isotopes.rs
